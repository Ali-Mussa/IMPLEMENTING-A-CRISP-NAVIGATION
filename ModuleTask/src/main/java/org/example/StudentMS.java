   ...
   public class StudentMS {
    ...
    JFrame frame;
    JPanel cardPanel, mainPanel, inputFormControl, formInput, viewPanel;
    JLabel titleLabel;
    ...
    public JPanel createMainMenu() {
        ...
        viewBtn = new JButton("View Student Records");
        ...
        mainPanel.add(titleLabel);        // Row 1
        mainPanel.add(buttonWrapper);     // Row 2
        mainPanel.add(darkModePanel);    // Row 3
    ...
    public JPanel createInputPanel() {
        inputFormControl = new JPanel(new BorderLayout(10, 50));
        inputFormControl.setPreferredSize(new Dimension(400, 500));

        formInput = new JPanel(new GridLayout(6, 2, 5, 5));
